(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(http) {
                    ...
                    this.usuario = [];
                    console.log(http);
                    http.get('http://localhost:5000/').subscribe(function (usuario) { return _this.usuario = usuario; });
                }
                return AppComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AtivarContaComponent = /** @class */ (function () {
                function AtivarContaComponent(alterarSenhaService, ativarContaService, router, formBuilder) {
                ...
                AtivarContaComponent.prototype.ngOnInit = function () {
                ...
                AtivarContaComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.cpf;
                    return this.alterarSenhaService.getInfoClienteLogin()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                        _this.onInfoClienteLogin()); });
                };
                AtivarContaComponent.prototype.onInfoClienteLogin = function () {
                    var _this = this;
                    return this.alterarSenhaService.getInfoClienteLogin()
                        .subscribe(function (clientex) {
                        _this.cpf = clientex[_this.indexCPF].cpf;
                    });
                };
                AtivarContaComponent.prototype.onAtivar = function () {
                    var _this = this;
                    this.getIndexCPF();
                    this.onInfoClienteLogin();
                    var newStatus = this.AtivarContaFormGroup.getRawValue();
                    this.ativarContaService
                        .ativarConta(newStatus)
                        .subscribe(function () {
                        _this.AtivarContaFormGroup.reset();
                        _this.reload();
                        _this.sucesso = true;
                        _this.erro = false;
                    }, function (err) {
                ...
                AtivarContaComponent.prototype.reload = function () {
                    this.router.navigate(['']);
                };
                return AtivarContaComponent;
            }());
            AtivarContaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL;
            var AtivarContaService = /** @class */ (function () {
                function AtivarContaService(http) {
                    this.http = http;
                    this.apiStatus = API + "/api/conta/ativar";
                }
                AtivarContaService.prototype.ativarConta = function (status) {
                    return this
                        .http.put(this.apiStatus, status, { headers: { 'Content-Type': 'application/json' } });
                };
                return AtivarContaService;
            }());
            AtivarContaService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CadastroComponent = /** @class */ (function () {
                function CadastroComponent(router, servico, _formBuilder, http) {
                    this.router = router;
                ...
                CadastroComponent.prototype.fileProgress = function (fileInput) {
                    this.Foto = fileInput.target.files[0];
                };
                CadastroComponent.prototype.onCadastro = function () {
                    var cliente = this.dadosPessoaisFormGroup.getRawValue();
                    var familiares = this.FamiliaresFormGroup.getRawValue();
                    var contato = this.contatoFormGroup.getRawValue();
                    var endereco = this.enderecoFormGroup.getRawValue();
                    var clienteLogin = this.clienteLoginFormGroup.getRawValue();
                    var senhaTransacoes = this.senhaFormGroup.getRawValue();
                    clienteLogin.cpf = cliente.cpf;
                    this.servico
                        .cadastro(cliente, familiares, contato, endereco, clienteLogin, senhaTransacoes)
                        .subscribe(function () { return console.log("Usuário cadastrado!"); }, function (err) { return console.log(err); });
                };
                CadastroComponent.prototype.onUpload = function () {
                    var _this = this;
                    var cliente = this.dadosPessoaisFormGroup.getRawValue();
                ...
                CadastroComponent.prototype.numberOnly = function (event) {
                ...
                CadastroComponent.prototype.letterOnly = function (event) {
                    var charCode = (event.which) ? event.which : event.keyCode;
                ...
                CadastroComponent.prototype.checkPasswords = function (group) {
                    var pass = group.controls.senhaAcesso.value;
                    var confirmPass = group.controls.confirmacaoSenha.value;
                    return pass === confirmPass ? null : { notSame: true };
                };
                CadastroComponent.prototype.onBuscaCEP = function () {
                    var _this = this;
                    var endereco = this.enderecoFormGroup.getRawValue();
                    this.servico.buscaCEP(endereco.cep)
                        .subscribe(function (address) { return _this.enderecoFormGroup = _this._formBuilder.group({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL;
            var CadastroService = /** @class */ (function () {
                function CadastroService(http) {
                    this.http = http;
                }
                CadastroService.prototype.cadastro = function (cliente, familiares, contato, endereco, clienteLogin, conta) {
                ...
                CadastroService.prototype.buscaCEP = function (cep) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                ...
                AuthGuard.prototype.cpf = function (cpf) {
                    this.cpff = cpf;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var API = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].API_URL;
            var AuthService = /** @class */ (function () {
                function AuthService(http, userService) {
                    this.http = http;
                    this.userService = userService;
                }
                AuthService.prototype.autenticar = function (cpf, senhaAcesso) {
                    var _this = this;
                    var httpOptions = {
                    ...
                    return this.http.post(API + '/api/token', { cpf: cpf, senhaAcesso: senhaAcesso }, { observe: 'response' })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.decode = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlterarInfoComponent = /** @class */ (function () {
                function AlterarInfoComponent(activatedRoute, infoContaService, alterarInfoService, formBuilder, servico) {
                ...
                AlterarInfoComponent.prototype.ngOnInit = function () {
                    this.getIndexCPF();
                    this.onInfoCliente();
                ...
                AlterarInfoComponent.prototype.numberOnly = function (event) {
                    var charCode = (event.which) ? event.which : event.keyCode;
                    if (charCode > 31 && (charCode < 48 || charCode > 57)) {
                        return false;
                    }
                ...
                AlterarInfoComponent.prototype.letterOnly = function (event) {
                    var charCode = (event.which) ? event.which : event.keyCode;
                    if (charCode > 31 && (charCode < 65 || charCode > 90) && (charCode < 97 || charCode > 122) &&
                        charCode != 32 && (charCode < 128 || charCode > 144) && (charCode < 147 || charCode > 154) &&
                        (charCode < 160 || charCode > 165) && (charCode < 181 || charCode > 183) &&
                ...
                AlterarInfoComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                        _this.onInfoCliente(),
                        _this.onInfoFamiliares(),
                        _this.onInfoContato(),
                        _this.onInfoEndereco()); });
                };
                // MÉTODOS "onInfo": MÉTODOS QUE SUBSTITUEM AS INFORMAÇÕES ANTIGAS PELAS NOVAS
                AlterarInfoComponent.prototype.onInfoCliente = function () {
                    var _this = this;
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) {
                        _this.nome = clientex[_this.indexCPF].nome;
                        _this.sobrenome = clientex[_this.indexCPF].sobrenome;
                        _this.cpf = clientex[_this.indexCPF].cpf;
                        _this.rg = clientex[_this.indexCPF].rg;
                        _this.orgaoEmissor = clientex[_this.indexCPF].orgaoEmissor;
                        _this.dtNascimento = clientex[_this.indexCPF].dtNascimento;
                        _this.dt1 = clientex[_this.indexCPF].dtNascimento.toString().substring(0, 10);
                        _this.nacionalidade = clientex[_this.indexCPF].nacionalidade;
                        _this.naturalidade = clientex[_this.indexCPF].naturalidade;
                    });
                };
                AlterarInfoComponent.prototype.onInfoFamiliares = function () {
                    var _this = this;
                    return this.alterarInfoService.getInfoFamiliares()
                        .subscribe(function (clientex) {
                        _this.nomeMae = clientex[_this.indexCPF].nomeMae;
                        _this.sobrenomeMae = clientex[_this.indexCPF].sobrenomeMae;
                        _this.nomePai = clientex[_this.indexCPF].nomePai;
                        _this.sobrenomePai = clientex[_this.indexCPF].sobrenomePai;
                    });
                };
                AlterarInfoComponent.prototype.onInfoContato = function () {
                    var _this = this;
                    return this.alterarInfoService.getInfoContato()
                        .subscribe(function (clientex) {
                        _this.email = clientex[_this.indexCPF].email;
                        _this.telResid = clientex[_this.indexCPF].telResid;
                        _this.telCel = clientex[_this.indexCPF].telCel;
                    });
                };
                AlterarInfoComponent.prototype.onInfoEndereco = function () {
                    var _this = this;
                    return this.alterarInfoService.getInfoEndereco()
                        .subscribe(function (clientex) {
                        _this.logradouro = clientex[_this.indexCPF].logradouro;
                        _this.numero = clientex[_this.indexCPF].numero;
                        _this.complemento = clientex[_this.indexCPF].complemento;
                        _this.bairro = clientex[_this.indexCPF].bairro;
                        _this.cidade = clientex[_this.indexCPF].cidade;
                        _this.siglaEstado = clientex[_this.indexCPF].siglaEstado;
                        _this.cep = clientex[_this.indexCPF].cep;
                    });
                };
                // MÉTODOS "onEditar": MÉTODOS QUE ATIVAM A FUNÇÃO DE ALTERAR INFORMAÇÕES NA PÁGINA "alterar-info"
                AlterarInfoComponent.prototype.onEditarPerfil = function () {
                ...
                AlterarInfoComponent.prototype.onEditarFamiliares = function () {
                ...
                AlterarInfoComponent.prototype.onEditarContato = function () {
                ...
                AlterarInfoComponent.prototype.onEditarEndereco = function () {
                ...
                AlterarInfoComponent.prototype.salvarAlteracoesPerfil = function () {
                    var _this = this;
                    var newPerfil = this.alterarPerfilFormGroup.getRawValue();
                    ...
                    this.alterarInfoService
                        ...
                        .subscribe(function () {
                        _this.sucessoPerfil = true;
                        _this.erroPerfil = false;
                        _this.onInfoCliente();
                        _this.onEditarPerfil();
                    }, function (err) {
                        _this.erroPerfil = true;
                        _this.sucessoPerfil = false;
                    });
                };
                AlterarInfoComponent.prototype.salvarAlteracoesFamiliares = function () {
                    var _this = this;
                    var newFamiliares = this.alterarFamiliaresFormGroup.getRawValue();
                    this.alterarInfoService
                        .alterarInfoFamiliares(this.cpf, newFamiliares)
                        .subscribe(function () {
                        _this.sucessoFamiliares = true;
                        _this.erroFamiliares = false;
                        _this.onInfoFamiliares();
                        _this.onEditarFamiliares();
                    }, function (err) {
                        _this.erroFamiliares = true;
                        _this.sucessoFamiliares = false;
                    });
                };
                AlterarInfoComponent.prototype.salvarAlteracoesContato = function () {
                    var _this = this;
                    var newContato = this.alterarContatoFormGroup.getRawValue();
                    this.alterarInfoService
                        .alterarInfoContato(this.cpf, newContato)
                        .subscribe(function () {
                        _this.sucessoContato = true;
                        _this.erroContato = false;
                        _this.onInfoContato();
                        _this.onEditarContato();
                    }, function (err) {
                        _this.sucessoContato = false;
                        _this.erroContato = true;
                    });
                };
                AlterarInfoComponent.prototype.salvarAlteracoesEndereco = function () {
                    var _this = this;
                    var newEndereco = this.alterarEnderecoFormGroup.getRawValue();
                    this.alterarInfoService
                        .alterarInfoEndereco(this.cpf, newEndereco)
                        .subscribe(function () {
                        _this.sucessoEndereco = true;
                        _this.erroEndereco = false;
                        _this.onInfoEndereco();
                        _this.onEditarEndereco();
                    }, function (err) {
                        _this.erroEndereco = true;
                        _this.sucessoEndereco = false;
                    });
                };
                AlterarInfoComponent.prototype.onBuscaCEP = function () {
                    var _this = this;
                    var endereco = this.alterarEnderecoFormGroup.getRawValue();
                    this.servico.buscaCEP(endereco.cep)
                        .subscribe(function (address) { return _this.alterarEnderecoFormGroup = _this.formBuilder.group({
                ...
                return AlterarInfoComponent;
            }());
            AlterarInfoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlterarInfoModule = /** @class */ (function () {
                function AlterarInfoModule() {
                }
                return AlterarInfoModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL;
            var AlterarInfoService = /** @class */ (function () {
                function AlterarInfoService(http) {
                    this.http = http;
                ...
                AlterarInfoService.prototype.getInfoCliente = function () {
                    return this.http.get(this.apiCliente);
                };
                AlterarInfoService.prototype.getInfoFamiliares = function () {
                    return this.http.get(this.apiFamiliares);
                };
                AlterarInfoService.prototype.getInfoContato = function () {
                    return this.http.get(this.apiContato);
                };
                AlterarInfoService.prototype.getInfoEndereco = function () {
                    return this.http.get(this.apiEnderecos);
                };
                // MÉTODOS QUE ALTERAM AS INFORMAÇÕES
                AlterarInfoService.prototype.alterarInfoPerfil = function (cpf, perfil) {
                    var apiClientes = '/api/Clientes/' + cpf;
                    return this
                        .http.put(API + apiClientes, perfil, { headers: { 'Content-Type': 'application/json' } });
                };
                AlterarInfoService.prototype.alterarInfoFamiliares = function (cpf, familiares) {
                    var apiFamiliares = '/api/Familiares/' + cpf;
                    return this
                        .http.put(API + apiFamiliares, familiares, { headers: { 'Content-Type': 'application/json' } });
                };
                AlterarInfoService.prototype.alterarInfoContato = function (cpf, contato) {
                    var apiContato = '/api/Contato/' + cpf;
                    return this
                        .http.put(API + apiContato, contato, { headers: { 'Content-Type': 'application/json' } });
                };
                AlterarInfoService.prototype.alterarInfoEndereco = function (cpf, endereco) {
                    var apiEndereco = '/api/Enderecos/' + cpf;
                    return this
                        .http.put(API + apiEndereco, endereco, { headers: { 'Content-Type': 'application/json' } });
                };
                return AlterarInfoService;
            }());
            AlterarInfoService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlterarSenhaComponent = /** @class */ (function () {
                function AlterarSenhaComponent(alterarSenhaService, formBuilder, activatedRoute) {
                    this.alterarSenhaService = alterarSenhaService;
                    this.formBuilder = formBuilder;
                    this.activatedRoute = activatedRoute;
                    this.sucesso = false;
                ...
                AlterarSenhaComponent.prototype.checkPasswords = function (group) {
                    var pass = group.controls.novaSenha.value;
                    var confirmPass = group.controls.confirmacaoNovaSenha.value;
                    return pass === confirmPass ? null : { notSame: true };
                };
                AlterarSenhaComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.alterarSenhaService.getInfoClienteLogin()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                AlterarSenhaComponent.prototype.onInfoClienteLogin = function () {
                    var _this = this;
                    return this.alterarSenhaService.getInfoClienteLogin()
                        .subscribe(function (clientex) {
                        _this.cpf = clientex[_this.indexCPF].cpf;
                ...
                AlterarSenhaComponent.prototype.alterarSenha = function () {
                    var _this = this;
                    var newClienteLogin = this.alterarSenhaFormGroup.getRawValue();
                ...
                AlterarSenhaComponent.prototype.reload = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL;
            var AlterarSenhaService = /** @class */ (function () {
                function AlterarSenhaService(http) {
                    this.http = http;
                    this.apiClienteLogin = API + "/api/ClienteLogin/";
                }
                AlterarSenhaService.prototype.getInfoClienteLogin = function () {
                    return this.http.get(this.apiClienteLogin);
                };
                AlterarSenhaService.prototype.alterarSenha = function (cpf, clienteLogin) {
                    return this
                        .http.put(this.apiClienteLogin + cpf, clienteLogin, { headers: { 'Content-Type': 'application/json' } });
                };
                return AlterarSenhaService;
            }());
            AlterarSenhaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfiguracoesComponent = /** @class */ (function () {
                ...
                ConfiguracoesComponent.prototype.onDados = function () {
                    this.conta = false;
                    this.senha = false;
                    this.dados = true;
                };
                ConfiguracoesComponent.prototype.onSenha = function () {
                    this.conta = false;
                    this.senha = true;
                    this.dados = false;
                };
                ConfiguracoesComponent.prototype.onConta = function () {
                    this.conta = true;
                    this.senha = false;
                    this.dados = false;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InativarContaComponent = /** @class */ (function () {
                function InativarContaComponent(router, activatedRoute, formBuilder, infoContaService, inativarContaService, userService) {
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                    this.formBuilder = formBuilder;
                    this.infoContaService = infoContaService;
                ...
                InativarContaComponent.prototype.ngOnInit = function () {
                    this.getIndexCPF();
                    this.onInfoCliente();
                ...
                InativarContaComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                InativarContaComponent.prototype.logout = function () {
                    this.userService.logout();
                    this.router.navigate(['']);
                };
                InativarContaComponent.prototype.onInfoCliente = function () {
                    var _this = this;
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) {
                        _this.cpf = clientex[_this.indexCPF].cpf;
                ...
                InativarContaComponent.prototype.inativarConta = function () {
                    var _this = this;
                    this.getIndexCPF();
                    this.onInfoCliente();
                    var newClienteLogin = this.inativarContaFormGroup.getRawValue();
                    this.inativarContaService
                        .inativarConta(this.cpf, newClienteLogin)
                        .subscribe(function () { return _this.logout(); }, function (err) {
                        console.log("Erro ao desativar conta");
                        _this.erro = true;
                    });
                };
                InativarContaComponent.prototype.reload = function () {
                    alert("Informações alteradas com sucesso!");
                    window.location.reload();
                };
                return InativarContaComponent;
            }());
            InativarContaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
            var InativarContaModule = /** @class */ (function () {
                function InativarContaModule() {
                }
                return InativarContaModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL;
            var InativarContaService = /** @class */ (function () {
                function InativarContaService(http) {
                    this.http = http;
                    this.apiConta = API + "/api/Conta/";
                    this.apiClienteLogin = API + "/api/clienteLogin/";
                }
                InativarContaService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                InativarContaService.prototype.getInfoLogin = function () {
                    return this.http.get(this.apiClienteLogin);
                };
                InativarContaService.prototype.inativarConta = function (cpf, conta) {
                    return this
                        .http.put(this.apiConta + cpf, conta, { headers: { 'Content-Type': 'application/json' } });
                };
                return InativarContaService;
            }());
            InativarContaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DepositoComponent = /** @class */ (function () {
                function DepositoComponent(servico, infoContaService, router, activatedRoute) {
                    this.servico = servico;
                    this.infoContaService = infoContaService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                ...
                DepositoComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                DepositoComponent.prototype.onInfoConta = function () {
                    var _this = this;
                    return this.infoContaService.getInfoConta()
                        .subscribe(function (clientex) { return _this.numeroConta = clientex[_this.indexCPF].numeroConta; });
                };
                DepositoComponent.prototype.onDeposito = function () {
                    var _this = this;
                    this.getIndexCPF();
                    var cpf = this.activatedRoute.snapshot.paramMap.get("cpf");
                    var transacao1 = this.form.getRawValue();
                    ...
                    this.servico.Deposito(transacao1)
                        .subscribe(function () {
                        _this.router.navigate(['feed/' + cpf]);
                        _this.sucesso = true;
                        _this.erro = false;
                    }, function (err) {
                        console.log("Erro de chamado");
            ...
            DepositoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _shared_saldo_saldo_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/saldo/saldo.module */ "./src/app/feed/shared/saldo/saldo.module.ts");
            var DepositoModule = /** @class */ (function () {
                function DepositoModule() {
                }
                return DepositoModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
            var DepositoService = /** @class */ (function () {
                function DepositoService(http) {
                    this.http = http;
                ...
                DepositoService.prototype.Deposito = function (transacao) {
                    return this
                        .http.post(this.apiTransacao, transacao, { headers: { 'Content-Type': 'application/json' } });
                };
                DepositoService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                return DepositoService;
            }());
            DepositoService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExtratoComponent = /** @class */ (function () {
                function ExtratoComponent(extratoService, activatedRoute, infoContaService) {
                ...
                ExtratoComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                ...
                ExtratoComponent.prototype.extrato = function () {
                    var _this = this;
                    this.extratoService.getInfoExtrato(this.getCpf)
                        .subscribe(function (stream) {
                        _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](stream);
                        _this.dataSource.paginator = _this.paginator;
                    });
                };
                ExtratoComponent.prototype.onInfoConta = function () {
                    var _this = this;
                    return this.infoContaService.getInfoConta()
                        .subscribe(function (clientex) { return _this.numeroConta = clientex[_this.indexCPF].numeroConta; });
                };
                ExtratoComponent.prototype.refresh = function () {
                    this.extrato();
                };
                return ExtratoComponent;
            }());
            ExtratoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ExtratoModule = /** @class */ (function () {
                function ExtratoModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var ExtratoService = /** @class */ (function () {
                function ExtratoService(http, activatedRoute) {
                    this.http = http;
                    this.activatedRoute = activatedRoute;
                ...
                ExtratoService.prototype.getInfoExtrato = function (conta) {
                    var apiExtrato = this.url + "api/Transacao/" + conta;
                    return this.http.get(apiExtrato);
                };
                ExtratoService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                ExtratoService.prototype.getInfoCliente = function () {
                    return this.http.get(this.apiCliente);
                };
                return ExtratoService;
            }());
            ExtratoService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FeedComponent = /** @class */ (function () {
                function FeedComponent(saldoService, activatedRoute, infoContaService, userService, router) {
                ...
                FeedComponent.prototype.onConfig = function () {
                ...
                FeedComponent.prototype.onSaldo = function () {
                    if (this.saldo == false) {
                ...
                FeedComponent.prototype.onInicio = function () {
                    this.inicio = true;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.onExtrato = function () {
                    this.inicio = false;
                    this.extrato = true;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.onDeposito = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = true;
                    this.saque = false;
                ...
                FeedComponent.prototype.onSaque = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = true;
                ...
                FeedComponent.prototype.onTransferencia = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.onAlterarDados = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.onAlterarSenha = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.onDesativarConta = function () {
                    this.inicio = false;
                    this.extrato = false;
                    this.deposito = false;
                    this.saque = false;
                ...
                FeedComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; })); });
                };
                FeedComponent.prototype.onExibeSaldo = function () {
                    var _this = this;
                    return this.saldoService.GetInfoSaldo()
                        .subscribe(function (saldox) { return _this.saldoAtual = saldox[_this.indexCPF].saldoAtual; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var InfoContaService = /** @class */ (function () {
                function InfoContaService(http) {
                    this.http = http;
                    this.url = "http://localhost:5000/api/";
                    this.apiCliente = this.url + "Clientes";
                ...
                InfoContaService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                InfoContaService.prototype.getInfoCliente = function () {
                    return this.http.get(this.apiCliente);
                };
                InfoContaService.prototype.getInfoAgencia = function () {
                    return this.http.get(this.apiAgencia);
                };
                return InfoContaService;
            }());
            InfoContaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InfosContaComponent = /** @class */ (function () {
                function InfosContaComponent(userService, infoContaService, activatedRoute, router) {
                    this.userService = userService;
                    this.infoContaService = infoContaService;
                    this.activatedRoute = activatedRoute;
                    this.router = router;
                ...
                InfosContaComponent.prototype.submit = function () {
                    if (this.form.valid) {
                        this.submitEM.emit(this.form.value);
                    }
                };
                InfosContaComponent.prototype.ngOnInit = function () {
                    this.getIndexCPF();
                    this.onInfoCliente();
                    this.onInfoConta();
                    this.onInfoAgencia();
                };
                InfosContaComponent.prototype.logout = function () {
                    this.userService.logout();
                    this.router.navigate(['']);
                };
                InfosContaComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                InfosContaComponent.prototype.onInfoCliente = function () {
                    var _this = this;
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) {
                        _this.nome = clientex[_this.indexCPF].nome;
                ...
                InfosContaComponent.prototype.onInfoConta = function () {
                    var _this = this;
                    return this.infoContaService.getInfoConta()
                        .subscribe(function (clientex) { return _this.numeroConta = clientex[_this.indexCPF].numeroConta; });
                };
                // AGENCIA SEMPRE TERÁ A MESMA POSIÇÃO ATÉ TER OUTRAS AGENCIAS.
                InfosContaComponent.prototype.onInfoAgencia = function () {
                    var _this = this;
                    return this.infoContaService.getInfoAgencia()
                        .subscribe(function (clientex) { return _this.numeroAgencia = clientex[0].numeroAgencia; });
                };
                return InfosContaComponent;
            }());
            InfosContaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _shared_saldo_saldo_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/saldo/saldo.module */ "./src/app/feed/shared/saldo/saldo.module.ts");
            var InfosContaModule = /** @class */ (function () {
                function InfosContaModule() {
                }
                return InfosContaModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _infos_conta_Infos_conta_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../infos-conta/Infos-conta.service */ "./src/app/feed/infos-conta/Infos-conta.service.ts");
            var SaqueComponent = /** @class */ (function () {
                function SaqueComponent(servico, infoContaService, router, activatedRoute) {
                    this.servico = servico;
                    this.infoContaService = infoContaService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                ...
                SaqueComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                SaqueComponent.prototype.onInfoConta = function () {
                    var _this = this;
                    return this.infoContaService.getInfoConta()
                        .subscribe(function (clientex) { return _this.numeroConta = clientex[_this.indexCPF].numeroConta; });
                };
                SaqueComponent.prototype.onSaque = function () {
                    var _this = this;
                    this.getIndexCPF();
                    var cpf = this.activatedRoute.snapshot.paramMap.get("cpf");
                    var transacao2 = this.form.getRawValue();
                    ...
                    this.servico.Saque(transacao2).subscribe(function () {
                        _this.router.navigate(['feed/' + cpf]);
                        _this.sucesso = true;
                        _this.erro = false;
                    }, function (err) {
            ...
            SaqueComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
            /* harmony import */ var _shared_saldo_saldo_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/saldo/saldo.module */ "./src/app/feed/shared/saldo/saldo.module.ts");
            var SaqueModule = /** @class */ (function () {
                function SaqueModule() {
                }
                return SaqueModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
            var API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL;
            var SaqueService = /** @class */ (function () {
                function SaqueService(http) {
                    this.http = http;
                    this.API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL;
                    this.apiConta = this.API + "api/Conta";
                    this.apiTransacao = this.API + '/api/Transacao';
                }
                SaqueService.prototype.Saque = function (transacao) {
                    return this
                        .http.post(this.apiTransacao, transacao, { headers: { 'Content-Type': 'application/json' } });
                };
                SaqueService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                return SaqueService;
            }());
            SaqueService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SaldoComponent = /** @class */ (function () {
                function SaldoComponent(saldoService, activatedRoute, infoContaService) {
                    this.saldoService = saldoService;
                    this.activatedRoute = activatedRoute;
                    this.infoContaService = infoContaService;
                }
                ...
                SaldoComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }, _this.onSaldo())); });
                };
                SaldoComponent.prototype.onSaldo = function () {
                    var _this = this;
                    this.getIndexCPF();
                    return this.saldoService.GetInfoSaldo()
                        .subscribe(function (saldox) { return _this.saldoAtual = saldox[_this.indexCPF].saldoAtual; });
            ...
            SaldoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SaldoService = /** @class */ (function () {
                function SaldoService(http) {
                    this.http = http;
                    this.url = "http://localhost:5000/";
                    this.apiConta = this.url + "api/conta";
                }
                SaldoService.prototype.GetInfoSaldo = function () {
                    return this.http.get(this.apiConta);
                };
                return SaldoService;
            }());
            SaldoService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TransferenciaComponent = /** @class */ (function () {
                function TransferenciaComponent(infoContaService, router, activatedRoute, servico) {
                    this.infoContaService = infoContaService;
                    this.router = router;
                    this.activatedRoute = activatedRoute;
                    this.servico = servico;
                ...
                TransferenciaComponent.prototype.submit = function () { };
                TransferenciaComponent.prototype.ngOnInit = function () {
                    this.getIndexCPF();
                };
                TransferenciaComponent.prototype.getIndexCPF = function () {
                    var _this = this;
                    var getCpf = this.activatedRoute.snapshot.paramMap.get('cpf');
                    return this.infoContaService.getInfoCliente()
                        .subscribe(function (clientex) { return (_this.indexCPF = clientex.findIndex(function (obj) { return obj.cpf == getCpf; }),
                ...
                TransferenciaComponent.prototype.onInfoConta = function () {
                    var _this = this;
                    return this.infoContaService.getInfoConta()
                        .subscribe(function (clientex) { return _this.numeroConta = clientex[_this.indexCPF].numeroConta; });
                };
                TransferenciaComponent.prototype.onTransferencia = function () {
                    var _this = this;
                    this.getIndexCPF();
                    var cpf = this.activatedRoute.snapshot.paramMap.get("cpf");
                    var transacao3 = this.form.getRawValue();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TransferenciaService = /** @class */ (function () {
                function TransferenciaService(http) {
                    this.http = http;
                    this.API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL;
                    this.apiConta = this.API + "api/Conta";
                    this.apiTransacao = this.API + '/api/Transacao';
                }
                TransferenciaService.prototype.Transferecia = function (transacao3) {
                    return this
                        .http.post(this.apiTransacao, transacao3, { headers: { 'Content-Type': 'application/json' } });
                };
                TransferenciaService.prototype.getInfoConta = function () {
                    return this.http.get(this.apiConta);
                };
                return TransferenciaService;
            }());
            TransferenciaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                ...
                HeaderComponent.prototype.recebeCpf = function (RespFilho) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(formBuilder, autorizacao, auth, router) {
                    this.formBuilder = formBuilder;
                ...
                LoginComponent.prototype.login = function () {
                    var _this = this;
                    var cpfDigitado = this.loginForm.get('cpf').value;
                    var senha = this.loginForm.get('senhaAcesso').value;
                    this.auth.cpf(cpfDigitado);
                    this.autorizacao.autenticar(cpfDigitado, senha)
                        .subscribe(function () { return _this.router.navigate(['feed/', cpfDigitado]); }, function (err) {
